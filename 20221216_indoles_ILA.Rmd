...
#load the data
########################################
metaboliteswide <- left_join(read.xlsx("P:/Shared_documents/Janina_Zuend/08_phd/14_working_package_3/02_Enrichment_ILA/20240103_Indole_data.xlsx", sheet = "indole_data_analysis"),
...
```{r}
write.xlsx(df_concentrations, "P:/Shared_documents/Janina_Zuend/08_phd/14_working_package_3/02_Enrichment_ILA/20240227_Indole_data_calculations.xlsx")
```
...
sub%>%
  t_test(Indolepropionate_mM ~ condition)%>%
  add_significance()%>%
...
```{r}
pure_cult <- read.xlsx("P:/Shared_documents/Janina_Zuend/08_phd/14_working_package_3/04_pureculture_screening/import/20240507_pure_culture_screening_merged_data.xlsx", sheet = "R_import")%>%
...
pure_cult%>%
  ...
  high = "cyan4", na.value = "gray95", name="Concentration [mM]")+
